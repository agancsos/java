...
class DataService {
	...
	public void createSchema() {
		...
		String[] queries = new String[] {
			"CREATE TABLE ACCOUNTS (ACCOUNT_ID SERIAL NOT NULL PRIMARY KEY, ACCOUNT_OWNER_FIRSTNAME VARCHAR(120) NOT NULL, ACCOUNT_OWNER_LASTNAME VARCHAR(400) NOT NULL, ACCOUNT_STATUS VARCHAR(30) DEFAULT 'ACTIVE', CREATED_DATE TIMESTAMP, LAST_UPDATED_DATE TIMESTAMP DEFAULT CURRENT_TIMESTAMP)",
			"CREATE TABLE TRANSACTIONS(TRANSACTION_ID SERIAL NOT NULL PRIMARY KEY, ACCOUNT_ID INTEGER NOT NULL, TRANSACTION_METHOD VARCHAR(10) DEFAULT 'CONSOLE', TRANSACTION_DIRECTION INTEGER DEFAULT '0', TRANSACTION_AMOUNT DECIMAL(100, 2) NOT NULL, TRANSACTION_PROCESSED INTEGER DEFAULT '0', TRANSACTION_BALANCE DECIMAL(100, 2) NOT NULL DEFAULT '0.00', LAST_UPDATED_DATE TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (ACCOUNT_ID) REFERENCES ACCOUNTS (ACCOUNT_ID))"
		};
