            ...
            <c:otherwise>
                <div class='grid-container'>
                        ...
                        <c:forEach items="${operations}" var="operation">
                            <c:choose>
                                <c:when test="${operation == selectedOperation}">
                                    <tr class="selected-page" onclick="window.location='${pageContext.request.contextPath}/console/admin/?op=${operation}&s=${param.s}'">
                                </c:when>
                                <c:otherwise>
                                    <tr onclick="window.location='${pageContext.request.contextPath}/console/admin/?op=${operation}&s=${param.s}'">
                                </c:otherwise>
                            </c:choose>
                            <td>${operation}</td>
                            </tr>
                    ...
                    <div class='grid-right'>
                        <jsp:include page="admin-form.jsp"/>
                    </div>
                </div>
            </c:otherwise>
        </c:choose>
